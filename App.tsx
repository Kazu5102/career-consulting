...
// App.tsx - v4.03 - Stability Protocol Update
...
const App: React.FC = () => {
    ...
    const showProtocolDetail = () => {
        alert(`【Stability Protocol 4.03 (v${VERSION})】\n\n1. 自動再試行メカニズムの導入（503 Overloaded/429を自動解消）\n2. 指数関数的バックオフ待機（1s, 2s, 4s）による負荷分散\n3. 分析エンジンの高速化（Flashモデル移行の最適化完了）\n4. ペイロード制限による通信タイムアウトの防止`);
    };
                    ...
                    <div className="flex items-center gap-3">
                        <div className="flex flex-col">
                            <div className="flex items-center gap-2">
                                ...
                                >
                                    <span>Stability Protocol 4.03</span>
