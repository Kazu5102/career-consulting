...
// App.tsx - v4.02 - Stability Protocol Update
...
const App: React.FC = () => {
    ...
    const showProtocolDetail = () => {
        alert(`【Stability Protocol 4.02 (v${VERSION})】\n\n1. 分析エンジンの高速化（Flashモデルへの完全移行）\n2. 5xx/Timeoutエラーの根本解決\n3. ペイロード最適化（通信効率の向上）\n4. リクエストリトライロジックの強化`);
    };
                    ...
                    <div className="flex items-center gap-3">
                        <div className="flex flex-col">
                            <div className="flex items-center gap-2">
                                ...
                                >
                                    <span>Stability Protocol 4.02</span>
