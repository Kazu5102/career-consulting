// api/gemini-proxy.ts - v6.36 - 2026-05-30 - キャリアリフレクションレポートフォーマットを「1.」「2.」に改修（案A）
...
「1. 本日お話ししたこと（テーマと事実）」および「2. 対話を通じて、あなたが気づいたこと・言葉にしたこと」の内容は、相談者が話した具体的な発話内容や表現に主観を挟まずに徹底して基づいてください。綺麗にまとめようとせず、相談者の「まとまらないありのままの言葉」をそのまま拾い上げてください。
