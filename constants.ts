...
// constants.ts
// v6.51 - 2026-06-26 - キャリア・リフレクションレポートの「心の可視化レポート」を4セクション（案A）に拡張し、アバタータイプ（wanko/human）に応じたナラティブ/ロジカルプロンプト分岐とリピート率向上を目指す内省の宿題の問い（最後の1文）を実装、およびAPI接続性確保に伴うバージョン同期
